...
def set_weather_data(data):
    ...
    global weather_data
    weather_data = data
    print(f"DEBUG: Wetterdaten gesetzt: {data}")
...
def create_ui():
    ...
    print("UI-Erstellung abgeschlossen.")
...
def oled_update_time():
    ...
    if date_label_obj is None or time_label_obj is None:
        print("DEBUG: Zeit-Labels sind None!")
        return
    ...
    try:
        ...
        # Debug nur alle 10 Sekunden
        if now[5] % 10 == 0:
            print(f"DEBUG: Zeit aktualisiert: {date_str} {time_str}")
...
def oled_update_weather():
    ...
    if main_screen is None or desc_label_obj is None:
        print("DEBUG: Wetter-Labels sind None!")
        return
    ...
    try:
        ...
        if data and all(val is not None for val in data):
            ...
            print(f"DEBUG: Wetter aktualisiert - {data[0]:.1f}°C, {data[5]}")
        else:
            ...
            print("DEBUG: Keine gueltigen Wetterdaten vorhanden")
